...
export function MatriculaExtemporaneaTable({ courses }) {
  return (
          ...
          <tbody className="bg-white rounded-b-lg">
            {courses.map((course, index) => (
              ...
              >
                ...
                <td className={`p-3 font-bold text-center ${course.LineaInscripcion < course.total ? 'text-green-500' : 'text-black-500'}`}>
                  {course.LineaInscripcion}
                </td>
